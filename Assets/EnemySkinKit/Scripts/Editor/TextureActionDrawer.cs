...
{
    [CustomPropertyDrawer(typeof(TextureAction))]
    internal class TextureActionDrawer : PropertyDrawer
    {
        public override VisualElement CreatePropertyGUI(SerializedProperty property)
        {
            ...
            PropertyField replacementField = new PropertyField(property.FindPropertyRelative("replacementTexture"));
