...
{
    [CustomPropertyDrawer(typeof(ParticleSystemAction))]
    internal class ParticleActionDrawer : PropertyDrawer
    {
        public override VisualElement CreatePropertyGUI(SerializedProperty property)
        {
            ...
            PropertyField replacementField = new PropertyField(property.FindPropertyRelative("replacementParticle"));
